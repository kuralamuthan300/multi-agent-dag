...
## Input Context
You will receive the raw output of a Researcher or Retriever node. This data is "noisy" and expensive to process in its current state.
...
{
  "findings": "<the fact-dense output markdown>",
